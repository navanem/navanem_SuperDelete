...
namespace SuperDelete.Core.Interop
{
    /// <summary>
    /// Win32 P/Invoke declarations used by the deletion engine. Moved verbatim from the original
    /// CLI so the proven long-path behaviour is preserved; kept <c>internal</c> to the Core library.
    /// </summary>
